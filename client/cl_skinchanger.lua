...
function ApplySkin(skin, clothes)
	...
	SetPedFaceFeature(playerPed, 8, (Character['cheeks_2'] / 10) + 0.0)
	SetPedFaceFeature(playerPed, 10, (Character['cheeks_3'] / 10) + 0.0)
	SetPedFaceFeature(playerPed, 11, (Character['eye_open'] / 10) + 0.0)
	SetPedFaceFeature(playerPed, 12, (Character['lips_thick'] / 10) + 0.0)
	SetPedFaceFeature(playerPed, 13, (Character['jaw_1'] / 10) + 0.0)
	SetPedFaceFeature(playerPed, 14, (Character['jaw_2'] / 10) + 0.0)
	SetPedFaceFeature(playerPed, 15, (Character['chin_height'] / 10) + 0.0)
	SetPedFaceFeature(playerPed, 16, (Character['chin_lenght'] / 10) + 0.0)
	SetPedFaceFeature(playerPed, 17, (Character['chin_width'] / 10) + 0.0)
	SetPedFaceFeature(playerPed, 18, (Character['chin_hole'] / 10) + 0.0)
	SetPedFaceFeature(playerPed, 19, (Character['neck_thick'] / 10) + 0.0)
	...
	SetPedComponentVariation(playerPed, 0, Character['face_ped'], Character['face_ped2'], 2)
	SetPedComponentVariation(playerPed, 1, Character['mask_ped'], Character['mask_ped'], 2)
