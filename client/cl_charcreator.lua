...
AddEventHandler('CreatePerso', function()
    ...
    SetEntityCoords(PlayerPedId(), 399.9, -998.7, -100.0)
		...
		if FirstSpawn then
			ESX.TriggerServerCallback('skin:getPlayerSkin', function(skin)
				if skin == nil then
                    ...
                    DoScreenFadeIn(1500)
                    DisplayRadar(false)
                    SetEntityCoords(PlayerPedId(), 406.03, -997.09, -100.00)
                    SetEntityHeading(PlayerPedId(), 93.19)
                    CreatorLoadContent()
                    AnimationIntro()
                    Citizen.Wait(1000)
                    FreezeEntityPosition(player, true)
...
CreaPerso = {
    ...
    BeardListingIndex = 1,
    BeardListingIndex2 = 0,
    BeardValue = {},

    EyebrownListingIndex = 1,
    EyebrownListingIndex2 = 0,
    EyebrowValue = {},

    BodyblemishesListingIndex = 1,
    BodyblemishesListingIndex2 = 0,
    BodyblemishesValue = {},

    WrinklesListingIndex = 1,
    WrinklesListingIndex2 = 0,
    WrinklesValue = {},
    ...
    FrecklesListingIndex2 = 0,
    FrecklesValue = {},

    ChestListingIndex = 1,
    ChestListingIndex2 = 0,
    VisagePed = 1,
    HautPed = 1,
    BasPed = 1,
    CasquePed = 1,
    ...
    MakeupListingIndex2 = 0,
    MakeupValue = {},

    LipstickListingIndex = 1,
    LipstickListingIndex2 = 0,
    LipstickValue = {},

    ComplexionListingIndex = 1,
    ComplexionListingIndex2 = 0,
    ComplexionValue = {},
	...
	FatherListCreator = {
        ...
        'Diego', 'Adrian', 'Gabriel', 'Michael', 'Santiago', 'Kevin', 'Louis', 'Samuel', 'Anthony', ' Claude', 'Niko', 'Titouan'
    },
    ...
    ListePersonage = {
        'g_m_importexport_01', 'g_m_m_armboss_01', 'g_m_m_armgoon_01', 'g_m_m_armlieut_01', 'g_m_m_chemwork_01',
        ...
        'a_m_m_soucent_04', 'a_m_m_og_boss_01', 'g_m_y_korean_01', 'g_m_y_korean_02', 'g_m_y_korlieut_01',
        'g_m_y_lost_01', 'g_m_y_lost_02', 'g_m_y_lost_03', 'g_m_y_mexgang_01', 'g_m_y_mexgoon_01',
        'g_m_y_mexgoon_02', 'g_m_y_mexgoon_03', 'g_m_y_pologoon_01', 'g_m_y_pologoon_02', 'g_m_y_salvaboss_01',
        'g_m_y_salvagoon_01', 'g_m_y_salvagoon_02', 'g_m_y_salvagoon_03', 'g_m_y_strpunk_01', 'g_m_y_strpunk_02',
        --Gang Female
        'g_f_importexport_01', 'g_f_y_ballas_01', 'g_f_y_families_01', 'g_f_y_lost_01', 'g_f_y_vagos_01',
        --Multiplayer
        'mp_f_bennymech_01', 'mp_f_boatstaff_01', 'mp_f_cardesign_01', 'mp_f_chbar_01', 'mp_f_counterfeit_01',
        'mp_f_forgery_01', 'mp_f_helistaff_01', 'mp_f_weed_01', 'mp_g_m_pros_01', 'mp_m_boatstaff_01',
        'mp_m_counterfeit_01', 'mp_m_exarmy_01', 'mp_m_forgery_01', 'mp_m_g_vagfun_01', 'mp_m_waremech_01',
        'mp_m_weapexp_01', 'mp_m_weapwork_01', 'mp_m_weed_01',
        --Scenario female
        's_f_m_fembarber', 's_f_m_maid_01', 's_f_m_sweatshop_01', 's_f_y_airhostess_01', 's_f_y_bartender_01',
        's_f_y_clubbar_01', 's_f_y_hooker_01', 's_f_y_hooker_02', 's_f_y_hooker_03', 's_f_y_migrant_01',
        's_f_y_movprem_01', 's_f_y_scrubs_01', 's_f_y_shop_low', 's_f_y_shop_mid', 's_f_y_stripper_01',
        's_f_y_stripper_02', 's_f_y_sweatshop_01', 's_f_y_casino_01',
        --Scenario male
        's_m_m_ammucountry', 's_m_m_autoshop_01', 's_m_m_autoshop_02', 's_m_m_bouncer_01', 's_m_m_ccrew_01',
        's_m_m_cntrybar_01', 's_m_m_dockwork_01', 's_m_m_doctor_01', 's_m_m_fiboffice_01', 's_m_m_fiboffice_02',
        ...
        's_m_m_lsmetro_01', 's_m_m_mariachi_01', 's_m_m_migrant_01', 's_m_m_movprem_01', 's_m_m_paramedic_01',
        's_m_m_postal_01', 's_m_m_postal_02', 's_m_m_scientist_01', 's_m_m_strpreach_01', 's_m_m_strvend_01',
        's_m_m_trucker_01', 's_m_m_ups_01', 's_m_m_ups_02', 's_m_o_busker_01', 's_m_y_airworker',
        's_m_y_ammucity_01', 's_m_y_armymech_01', 's_m_y_autopsy_01', 's_m_y_barman_01', 's_m_y_busboy_01',
        's_m_y_chef_01', 's_m_y_clown_01', 's_m_y_clubbar_01', 's_m_y_construct_01', 'a_m_m_soucent_01',
        's_m_y_dealer_01', 's_m_y_devinsec_01', 's_m_y_dockwork_01', 's_m_y_doorman_01', 's_m_y_dwservice_01',
        's_m_y_dwservice_02', 's_m_y_garbage', 's_m_y_grip_01', 's_m_y_mime', 's_m_y_prismuscl_01',
        's_m_y_prisoner_01', 's_m_y_robber_01', 's_m_y_shop_mask', 's_m_y_strvend_01', 's_m_y_valet_01',
        's_m_y_waiter_01', 's_m_y_waretech_01', 's_m_y_winclean_01', 's_m_y_xmech_02',
        --Story
        'ig_abigail', 'ig_ashley', 'ig_avon', 'ig_bankman', 'ig_barry',
        'ig_benny', 'ig_bestmen', 'ig_beverly', 'ig_bride', 'ig_car3guy1',
        'ig_car3guy2', 'ig_chengsr', 'ig_clay', 'ig_claypain', 'ig_cletus',
        'ig_dale', 'ig_dix', 'ig_djblamadon', 'ig_djblamrupert', 'ig_djblamryans',
        'ig_djdixmanager', 'ig_djgeneric_01', 'ig_djsolfotios', 'ig_djsoljakob', 'ig_djsolmanager',
        'ig_djsolmike', 'ig_djsolrobt', 'ig_djtalaurelia', 'ig_djtalignazio', 'ig_dreyfuss',
        'ig_englishdave', 'ig_fbisuit_01', 'ig_g', 'ig_groom', 'ig_hao',
        'ig_janet', 'ig_jewelass', 'ig_jimmyboston', 'ig_jimmyboston_02', 'ig_joeminuteman',
        'ig_josef', 'ig_josh', 'ig_kerrymcintosh', 'ig_kerrymcintosh_02', 'ig_lacey_jones_02',
        'ig_lazlow_2', 'ig_lestercrest_2', 'ig_lifeinvad_01', 'ig_lifeinvad_02', 'ig_magenta',
        'ig_malc', 'ig_manuel', 'ig_marnie', 'ig_maryann', 'ig_maude',
        'ig_money', 'ig_mrs_thornhill', 'ig_mrsphillips', 'ig_natalia', 'ig_nigel',
        'ig_old_man1a', 'ig_old_man2', 'ig_oneil', 'ig_ortega', 'ig_paige',
        'ig_paper', 'ig_popov', 'ig_priest', 'csb_ramp_gang', 'ig_ramp_hic',
        'ig_ramp_hipster', 'ig_ramp_mex', 'ig_rashcosvki', 'ig_roccopelosi', 'ig_russiandrunk',
        'ig_sacha', 'ig_screen_writer', 'ig_sol', 'ig_talcc', 'ig_talina',
        'ig_talmm', 'ig_tanisha', 'ig_terry', 'ig_tomepsilon', 'ig_tonya',
        'ig_tonyprince', 'ig_tylerdix', 'ig_tylerdix_02', 'ig_vagspeak', 'ig_zimbor',
        --Story scenario female
        'u_f_m_miranda', 'u_f_m_miranda_02', 'u_f_m_promourn_01', 'u_f_o_moviestar', 'u_f_o_prolhost_01',
        'u_f_y_bikerchic', 'u_f_y_comjane', 'u_f_y_danceburl_01', 'u_f_y_dancelthr_01', 'u_f_y_dancerave_01',
        'u_f_y_hotposh_01', 'u_f_y_jewelass_01', 'u_f_y_mistress', 'u_f_y_poppymich', 'u_f_y_poppymich_02',
        'u_f_y_princess', 'u_f_y_spyactress',
        --Story scenario male
        'u_m_m_aldinapoli', 'u_m_m_bankman', 'u_m_m_bikehire_01', 'u_m_m_doa_01', 'u_m_m_edtoh',
        'u_m_m_fibarchitect', 'u_m_m_filmdirector', 'u_m_m_glenstank_01', 'u_m_m_griff_01', 'u_m_m_jesus_01',
        'u_m_m_jewelsec_01', 'u_m_m_jewelthief', 'u_m_m_markfost', 'u_m_m_partytarget', 'u_m_m_promourn_01',
        'u_m_m_rivalpap', 'u_m_m_spyactor', 'u_m_m_willyfist', 'u_m_o_finguru_01', 'u_m_o_taphillbilly',
        'u_m_o_tramp_01', 'u_m_y_abner', 'u_m_y_antonb', 'u_m_y_baygor', 'u_m_y_burgerdrug_01',
        'u_m_y_chip', 'u_m_y_cyclist_01', 'u_m_y_babyd', 'u_m_y_danceburl_01', 'u_m_y_dancelthr_01',
        'u_m_y_dancerave_01', 'u_m_y_fibmugger_01', 'u_m_y_guido_01', 'u_m_y_gunvend_01', 'u_m_y_hippie_01',
        'u_m_y_imporage', 'u_m_y_justin', 'u_m_y_mani', 'u_m_y_militarybum', 'u_m_y_paparazzi',
        'u_m_y_party_01', 'u_m_y_prisoner_01', 'u_m_y_sbike', 'u_m_y_smugmech_01', 'u_m_y_staggrm_01', 'u_m_y_tattoo_01',
        --Cutscene
        'csb_grove_str_dlr', 'csb_hugh', 'csb_imran', 'csb_jackhowitzer', 'csb_janitor',
        'csb_mrs_r', 'csb_oscar', 'csb_porndudes', 'csb_undercover',
        --Ambient female
        'a_f_m_beach_01', 'a_f_m_bevhills_01', 'a_f_m_bevhills_02', 'a_f_m_business_02', 'a_f_m_downtown_01',
        'a_f_m_eastsa_01', 'a_f_m_eastsa_02', 'a_f_m_fatbla_01', 'a_f_m_fatcult_01', 'a_f_m_fatwhite_01',
        'a_f_m_ktown_01', 'a_f_m_ktown_02', 'a_f_m_prolhost_01', 'a_f_m_salton_01', 'a_f_m_skidrow_01',
        'a_f_m_soucent_01', 'a_f_m_soucent_02', 'a_f_m_soucentmc_01', 'a_f_m_tourist_01', 'a_f_m_tramp_01',
        'a_f_m_trampbeac_01', 'a_f_o_genstreet_01', 'a_f_o_indian_01', 'a_f_o_ktown_01', 'a_f_o_salton_01',
        'a_f_o_soucent_01', 'a_f_o_soucent_02', 'a_f_y_beach_01', 'a_f_y_bevhills_01', 'a_f_y_bevhills_02',
        'a_f_y_bevhills_03', 'a_f_y_bevhills_04', 'a_f_y_business_01', 'a_f_y_business_02', 'a_f_y_business_03',
        'a_f_y_business_04', 'a_f_y_clubcust_01', 'a_f_y_clubcust_02', 'a_f_y_clubcust_03', 'a_f_y_eastsa_01',
        'a_f_y_eastsa_02', 'a_f_y_eastsa_03', 'a_f_y_epsilon_01', 'a_f_y_femaleagent', 'a_f_y_fitness_01',
        'a_f_y_fitness_02', 'a_f_y_genhot_01', 'a_f_y_golfer_01', 'a_f_y_hiker_01', 'a_f_y_hippie_01',
        'a_f_y_hipster_01', 'a_f_y_hipster_02', 'a_f_y_hipster_03', 'a_f_y_hipster_04', 'a_f_y_indian_01',
        'a_f_y_juggalo_01', 'a_f_y_runner_01', 'a_f_y_rurmeth_01', 'a_f_y_scdressy_01', 'a_f_y_skater_01',
        'a_f_y_soucent_01', 'a_f_y_soucent_02', 'a_f_y_soucent_03', 'a_f_y_tennis_01', 'a_f_y_topless_01',
        'a_f_y_tourist_01', 'a_f_y_tourist_02', 'a_f_y_vinewood_01', 'a_f_y_vinewood_02', 'a_f_y_vinewood_03',
        'a_f_y_vinewood_04', 'a_f_y_yoga_01', 'a_m_m_acult_01', 'a_m_m_afriamer_01', 'a_m_m_beach_01',
        ...
        'a_m_y_bevhills_02', 'a_m_y_breakdance_01', 'a_m_y_busicas_01', 'a_m_y_business_01', 'a_m_y_business_02',
        'a_m_y_business_03', 'a_m_y_clubcust_01', 'a_m_y_clubcust_02', 'a_m_y_clubcust_03', 'a_m_y_cyclist_01',
        ...
        'a_m_y_golfer_01', 'a_m_y_hasjew_01', 'a_m_y_hiker_01', 'a_m_y_hippy_01', 'a_m_y_hipster_01',
        'a_m_y_hipster_02', 'a_m_y_hipster_03', 'a_m_y_indian_01', 'a_m_y_jetski_01', 'a_m_y_juggalo_01',
        'a_m_y_ktown_01', 'a_m_y_ktown_02', 'a_m_y_latino_01', 'a_m_y_methhead_01', 'a_m_y_mexthug_01',
        'a_m_y_motox_01', 'a_m_y_motox_02', 'a_m_y_musclbeac_01', 'a_m_y_musclbeac_02', 'a_m_y_polynesian_01',
        'a_m_y_roadcyc_01', 'a_m_y_runner_01', 'a_m_y_runner_02', 'a_m_y_salton_01', 'a_m_y_skater_01',
        'a_m_y_skater_02', 'a_m_y_soucent_01', 'a_m_y_soucent_02', 'a_m_y_soucent_03', 'a_m_y_soucent_04',
        'a_m_y_stbla_01', 'a_m_y_stbla_02', 'a_m_y_stlat_01', 'a_m_y_stwhi_01', 'a_m_y_stwhi_02',
        'a_m_y_sunbathe_01', 'a_m_y_surfer_01', 'a_m_y_vindouche_01', 'a_m_y_vinewood_01', 'a_m_y_vinewood_02', 'a_m_y_vinewood_03',
...
CreaPerso.menu = RageUI.CreateMenu('', 'Personnage', nil, nil, 'F5_content', 'identite')
CreaPerso.Personnage = RageUI.CreateSubMenu(CreaPerso.menu, '', 'Personnage', nil, nil, 'F5_content', 'identite')
CreaPerso.CharHeritageMenu = RageUI.CreateSubMenu(CreaPerso.menu, '', 'Héritage', nil, nil, 'F5_content', 'identite')
CreaPerso.Appearance = RageUI.CreateSubMenu(CreaPerso.menu, '', 'Apparence', nil, nil, 'F5_content', 'identite')
CreaPerso.TraitVisage = RageUI.CreateSubMenu(CreaPerso.menu, '', 'Visage', nil, nil, 'F5_content', 'identite')
CreaPerso.TraitVisage2 = RageUI.CreateSubMenu(CreaPerso.menu, '', 'Visage', nil, nil, 'F5_content', 'identite')
CreaPerso.VetementPed = RageUI.CreateSubMenu(CreaPerso.menu, '', 'Vêtement', nil, nil, 'F5_content', 'identite')
CreaPerso.Makeup = RageUI.CreateSubMenu(CreaPerso.menu, '', 'Makeup', nil, nil, 'F5_content', 'identite')
CreaPerso.Identity = RageUI.CreateSubMenu(CreaPerso.menu, '', 'Identité', nil, nil, 'F5_content', 'identite')
...
CreaPerso.menu:DisplayGlare(false)
CreaPerso.Personnage:DisplayGlare(false)
CreaPerso.CharHeritageMenu:DisplayGlare(false)
CreaPerso.Appearance:DisplayGlare(false)
CreaPerso.TraitVisage:DisplayGlare(false)
CreaPerso.TraitVisage2:DisplayGlare(false)
CreaPerso.VetementPed:DisplayGlare(false)
CreaPerso.Makeup:DisplayGlare(false)
CreaPerso.Identity:DisplayGlare(false)
...
AddEventHandler('RefreshDiamond', function()
    ESX.TriggerServerCallback('GetDiamandPlayer', function(result)
            ...
            while CreaPerso.openedMenu do
                ...
                RageUI.IsVisible(CreaPerso.menu, function()
                    if not CreaPerso.Board then
                        ...
                        Citizen.Wait(100)
                        TaskPlayAnim(PlayerPedId(), 'mp_character_creation@customise@male_a', 'loop', 2.5, -1.0,-1, 2, 0, 0, 0,0)
                        CreaPerso.Board = true
                    end

                    if not inPrincipal then
                        inPrincipal = true CreatorZoomOut(GetCreatorCam())
                    end
                ...
                RageUI.IsVisible(CreaPerso.Personnage, function()
                    ...
                    if CreaPerso.Board then
                        ...
                        RequestAnimDict('mp_character_creation@customise@male_a')
                        TaskPlayAnim(PlayerPedId(), 'mp_character_creation@customise@male_a', 'drop_loop', 3.0, -1.0, -1, 2, 0, 0, 0, 0)
                    ...
                    RageUI.Button('mp_m_freemode_01', false, {}, true, {
                        onActive = function()
                            if CreaPerso.SexPerso ~= 0 then
                                TriggerEvent('skinchanger:change', 'sex', 0)
                                FreezeEntityPosition(player, false)
                                SetEntityCoords(PlayerPedId(), 402.9375, -996.9771, -99.00025-1.0)
                                SetEntityHeading(PlayerPedId(), 181.046)
                        ...
                        onSelected = function()
                            ...
                            if Input ~= nil then
                                if string.match(Input ,'%d+') then
                                    ESX.ShowNotification('~r~Veuillez ne pas indiquer des nombres')
                                else
                        ...
                        onSelected = function()
                            ...
                            if Input ~= nil then
                                if not IsDateGood(Input) then
                                    ESX.ShowNotification('~r~Veuillez indiquer une bonne date')
                                else
                        ...
                        onSelected = function()
                            ...
                            if Input ~= nil then
                                if not string.match(Input ,'%d+') then
                                    ESX.ShowNotification('~r~Veuillez indiquer des nombres')
                                else
                ...
                RageUI.IsVisible(CreaPerso.TraitVisage, function()
                    ...
                    RageUI.Button('Longueur de \'os du menton', false, {}, true, {})
                ...
                RageUI.IsVisible(CreaPerso.Appearance, function()
                    ...
                    RageUI.List('Liste des coiffures', CreaPerso.HairValue, CreaPerso.HairListingIndex, nil, {}, true, {
                        onListChange = function(Index)
                            ...
                            TriggerEvent('skinchanger:change', 'hair_1', CreaPerso.HairListingIndex)
                        end,
                        onActive = function()
                            itemButton = true
                        end
...
function AnimationIntro()
    ...
    Citizen.Wait(4685)
    TaskPlayAnim(PlayerPedId(), 'mp_character_creation@customise@male_a', 'loop', 1.0, -1.0, -1, 2, 0, 0, 0, 0)
end
...
function CreateBoard()
    ...
    while not HasModelLoaded(board_model) do
        Wait(0)
    end

    RequestModel(overlay_model)
    while not HasModelLoaded(overlay_model) do
        Wait(0)
    end
